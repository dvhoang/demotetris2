...
public class TetrisPanel extends JPanel {
    private final int GRID_WIDTH = 20; // Chiều rộng bản đồ chơi
    private final int GRID_HEIGHT = 30; // Chiều cao bản đồ chơi
    private final int CELL_SIZE = 20; // Kích thước 1 ô
    public int[][] binMap;
    private int currentCol = -1;
    private int currentRow = -1;

    // Khai báo các màu sắc dưới dạng hằng số
    private final Color COLOR_FILLED = Color.decode("#E88D67");
